 ...
 */
public class ListfrontCompetitionForm extends BaseForm{
       Form current;
    public ListfrontCompetitionForm(Resources res) {
    
    super("Newsfeed", BoxLayout.y());
        Toolbar tb = new Toolbar(true);
        setToolbar(tb);
        getTitleArea().setUIID("Container");
        setTitle("Compétition");
        ...
        RadioButton rando = RadioButton.createToggle("Cadeaux", barGroup);
        rando.setUIID("SelectBar");
        RadioButton histo = RadioButton.createToggle("Compétitions", barGroup);
      ...
      new ListfrontCadeauForm(res).show();
        ...
        InfiniteProgress ip = new InfiniteProgress();
        final Dialog ipD1g= ip.showInfiniteBlocking();
      new ListfrontCompetitionForm(res).show();
    ...
    // appel affichage 
    ArrayList<Competition> list = ServiceCompetition.getInstance().affichageCompetition();
    
    for(Competition p : list ) {
    ...
    private void addButton(Image img,Competition p,Resources res) {
     ...
     Label nomText = new Label ("Nom:"+p.getNom(),"NewsTopLine2");
      Label descriptionText = new Label ("Distance:"+p.getDistance(),"NewsTopLine2");
       ...
       Label dateText = new Label ("date:"+p.getDate(),"NewsTopLine2");
             ...
             dig.dispose();
                     ...
                     if(ServiceCompetition.getInstance().deleteCompetition(p.getId()))  {
           ...
           lModifier.setUIID("NewsTopLine2");
            ...
            new ModifierCompetitionForm(res,p).show();
