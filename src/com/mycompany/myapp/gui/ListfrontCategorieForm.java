 ...
 * @author msi
 */
public class ListfrontCategorieForm extends BaseForm{
    
    
    
    Form current;
    public ListfrontCategorieForm(Resources res) {
   ...
   private void addTab(Tabs swipe, Image img, Label spacer, String likesStr, String commentsStr, String text) {
    ...
    private void addButton(Image img,Categorie p,Resources res) {
     ...
     Label nomText = new Label ("Nom:"+p.getNom(),"NewsTopLine2");
      Label descriptionText = new Label ("description:"+p.getDescription(),"NewsTopLine2");
             ...
             if (dig.show("suppression","vouslez-vous supprimer cette Categorie?","Annuler","oui")){
           ...
           lModifier.setUIID("NewsTopLine2");
            ...
            new ModifierCategorieForm(res,p).show();
