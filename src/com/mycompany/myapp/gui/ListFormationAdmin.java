 ...
 * @author seifi
 */
public class ListFormationAdmin extends BaseFormBack {
     Form current;
    public ListFormationAdmin (Resources res) 
    {
    ...
    image.setBackgroundType(Style.BACKGROUND_IMAGE_SCALED_FILL);
       ...
       private void addTab(Tabs swipe, Image img, Label spacer, String likesStr, String commentsStr, String text) {
        ...
        private void addButton(Image img,Formation pf,Resources res) {
        ...
        */
        ...
        lSupprimer.addPointerPressedListener(l -> {
            ...
            if (dig.show("suppression","voulez-vous supprimer cette formation?","Annuler","oui")){
                ...
                if(ServiceFormation.getInstance().deleteFormation(pf.getId()))  {
                    new ListFormationAdmin(res).show();
        ...
        */
        ...
        lModifier.addPointerPressedListener(l -> {
            ...
            //System.out.println("modifier");
            new ModifierFormationForm(res,pf).show();
        ...
        cnt.add(BorderLayout.CENTER,BoxLayout.encloseY
                                (BoxLayout.encloseX(nomeqText,lModifier,lSupprimer),
