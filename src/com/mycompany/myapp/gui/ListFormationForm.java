...
public class ListFormationForm extends BaseForm{
    ...
    super("Newsfeed", BoxLayout.y());
        ...
        add(LayeredLayout.encloseIn(
                GridLayout.encloseIn(1,Publications),
    ...
    private void addButton(Image img,Formation pf,Resources res) {//tetbadel participant
        ...
        Label expText = new Label ("Experience:"+pf.getExp(),"NewsTopLine2");
        Label so_domaineText = new Label ("Domaine:"+pf.getSo_domaine(),"NewsTopLine2");
        Label so_assText = new Label ("association:"+pf.getSo_ass(),"NewsTopLine2");
        Label so_Numero = new Label ("Numero:"+pf.getNumero(),"NewsTopLine2");
        */
        
        
        Label nomeqText = new Label ("nom:"+pf.getNomeq(),"NewsTopLine2");
        Label domaineText = new Label ("domaine:"+pf.getDomaine(),"NewsTopLine2");
        Label dureeText = new Label ("duree:"+pf.getDuree(),"NewsTopLine2");
        Label nomformText = new Label ("NomForm:"+pf.getNomform(),"NewsTopLine2");
        Label planText = new Label ("Domaine:"+pf.getPlan(),"NewsTopLine2");
        Label dateText = new Label ("Date:"+pf.getDate(),"NewsTopLine2");
          ...
          Label b= new Label(" ");
           ...
           new addParticFormForm(pf,res).show();
              ...
              cnt.add(BorderLayout.CENTER,BoxLayout.encloseY
                (BoxLayout.encloseX(nomeqText,b),
                BoxLayout.encloseX(domaineText),
                BoxLayout.encloseX(dureeText),
                BoxLayout.encloseX(nomformText),
                BoxLayout.encloseX(planText),
