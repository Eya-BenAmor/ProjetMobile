 ...
 */
public class AjoutCadeauForm extends BaseFormBack{
       Form current;
    public AjoutCadeauForm(Resources res ){
    ...
    addStringValue("nom",nom);
     ...
     TextField categorie = new TextField("","saisir la categorie  !");
    categorie.setUIID("TextFieldBlack");
    addStringValue("categorie_cadeau",categorie);
    
     TextField description = new TextField("","saisir la description  !");
    description.setUIID("TextFieldBlack");
    addStringValue("description_cadeau",description);
    ...
    try {
        if (nom.getText().equals("") || categorie.getText().equals(""))
        {
        Dialog.show("vérifier vos données","","Annuler","ok");
            ...
            ServiceCadeau.getInstance().ajoutCadeau(p);
            iDialog.dispose();
