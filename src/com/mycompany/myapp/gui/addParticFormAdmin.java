 ...
 * @author seifi
 */
public class addParticFormAdmin extends BaseFormBack{
     Form current;
    public addParticFormAdmin(Resources res ){
    ...
    try {
        ...
        Dialog.show("vérifier vos données","","Annuler","ok");
            ...
            ParticForm pf = new ParticForm(
                    ...
                    String.valueOf(so_ass.getText()).toString()
                    
           );
            
            System.out.println("ParticForm =="+pf);
            
            ServiceParticForm.getInstance().ajoutParticForm(pf);
            iDialog.dispose();
