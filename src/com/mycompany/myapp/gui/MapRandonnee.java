 ...
 * @author Chadi
 */
public class MapRandonnee extends BaseForm{
Form f = new Form();
  MapContainer cnt = null;
public MapRandonnee(Resources res) {
    ...
    try{
        ...
        Button btnMoveCamera = new Button("Pays Randonnée");
       ...
       btnAnnuler.addActionListener(e -> {
        ...
        Container root = new Container();
         ...
         f.addComponent(BorderLayout.NORTH, btnAnnuler);
