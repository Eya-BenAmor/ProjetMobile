...
import com.mycompany.myapp.gui.ModifierPublicationForm;
...
public class ListPublicationForm extends BaseForm {
    ...
    public ListPublicationForm(Resources res) {
     ...
     super("Newsfeed", BoxLayout.y());
        ...
        addTab(swipe, res.getImage("rando.jpg"), spacer1, "Bienvenue");
    ...
    image.setBackgroundType(Style.BACKGROUND_IMAGE_SCALED_FILL);
      ...
      // BOUTON CONSULTER L HEURE 
       ...
       btnAnnuler.addActionListener(f-> {
        ...
        cl.addComponent(BorderLayout.NORTH, btnAnnuler);
        clock.start();
        cl.show();
      ...
      Label descriptionText = new Label ("Description:"+p.getDescription(),"NewsTopLine2");
          ...
          Label b= new Label(" ");
           b.setUIID("NewsTopLine");
             ...
             new AjouterCommentaire(res,p).show();
             
             
             
             });
                  Label b2= new Label(" ");
           b2.setUIID("NewsTopLine");
             Style b2Style = new Style(b.getUnselectedStyle());
             b2Style.setFgColor(0xf7ad02);
             
             FontImage b2FontImage=FontImage.createMaterial(FontImage.MATERIAL_IMAGE_SEARCH, b2Style);
                 b2.setIcon(b2FontImage);
             b2.setTextPosition(LEFT);
         
               b2.addPointerPressedListener(l -> {
             
             //System.out.println("modifier");
                        
             new ListerCommentaire(res,p).show();
        ...
        (BoxLayout.encloseX(nomText,lModifier,lSupprimer,b,b2),
